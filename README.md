...
- A/B testing - предпологает развернутую новую версию(или несколько), доступ к которой осуществляется за счет ЛБ при определенных условиях (языка, геопозиции, ОС, параметрам запроса и т.д.) 
